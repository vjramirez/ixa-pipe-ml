 ...
 */
public class DocumentClassificationSample {
	...
	private final String category;
	  ...
	  public DocumentClassificationSample(String category, String[] text,
		      final boolean clearAdaptiveData) {
	    this(category, text, null, clearAdaptiveData);
	  }

	  public DocumentClassificationSample(String category, String[] text, Map<String, Object> extraInformation,
		      final boolean clearAdaptiveData) {
	  ...
	  public boolean equals(Object obj) {
	    ...
	    if (obj instanceof DocumentClassificationSample) {
	    	DocumentClassificationSample a = (DocumentClassificationSample) obj;
